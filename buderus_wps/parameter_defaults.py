...
PARAMETER_DEFAULTS = [
    ...
    {'idx': 2473, 'extid': 'EE1597E1AD010E', 'max': 650, 'min': 500, 'format': 'tem', 'read': 0, 'text': 'XDHW_STOP_TEMP' },
    {'idx': 2475, 'extid': 'E1263DCA71010F', 'max': 48, 'min': 0, 'format': 'int', 'read': 0, 'text': 'XDHW_TIME' },
