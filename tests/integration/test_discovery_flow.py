...
class MockCANAdapter:
    ...
    def __init__(self, element_count: int = 3, elements: List[Dict] = None):
        ...
        self.elements = elements or [
            {"idx": 0, "extid": "814A53C66A0802", "max": 0, "min": 0, "text": "ACCESSORIES_CONNECTED_BITMASK"},
            {"idx": 1, "extid": "61E1E1FC660023", "max": 5, "min": 0, "text": "ACCESS_LEVEL"},
            {"idx": 11, "extid": "E555E4E11002E9", "max": 40, "min": -30, "text": "ADDITIONAL_BLOCK_HIGH_T2_TEMP"},
        ]
